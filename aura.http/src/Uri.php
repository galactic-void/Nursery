...
class Uri
{
     ...
     * __get() with $query.
     * 
     * If you access this property, Builder treats Builder::$query as
     * authoritative, *not* the internal Builder::$query_str. If the
    ...
    /**
     * 
     * Magic set to access the properties scheme, host, port, 
     * user, pass, path, format, query and fragment. 
     * 
    ...
    /**
     * 
     * Magic get to access the properties scheme, host, port, 
     * user, pass, path, format, query and fragment. 
     * 
    ...
    public function __clone()
    {
        ...
        if ($this->construct_uri) {
            $this->set($this->construct_uri);
        }
    }
    ...
    /**
     * 
     * Sets the query string in the URI, for Builder::getQuery() and
     * Builder::$query.
     * 
    ...
    /**
     * 
     * Returns the query portion as a string.  When [[Builder::$query | ]]
     * is non-null, uses [[php::http_build_query() | ]] on it; otherwise, 
     * returns the [[Builder::$query_str]] property.
     * 
    ...
    /**
     * 
     * Sets the Builder::$path array from a string.
     * 
    ...
    public function getPath()
    {
        ...
        return (empty($this->path)         ? '' : $this->pathEncode($this->path))
    ...
    protected function loadQuery()
    {
        ...
        // will have no effect since $GET is already populated, it still
        // affects the behavior of parse_str().
        $old = get_magic_quotes_gpc(); // todo
     ...
     * characters found in Builder::$encode_path.
     * 
